...
graph TD
    ...
    G --> H[Gemini API Call: gemini-flash-lite-latest]
...
* **Model Selection:** Integrates `gemini-flash-lite-latest`, reducing overall end-to-end vision latency from **30 seconds to under 3 seconds** (a **90% latency reduction**).
