...
* **Model Selection:** Integrates `gemini-3.1-flash-lite`, reducing overall end-to-end vision latency from **30 seconds to under 2 seconds** (over **93% latency reduction** and 6x cost savings).
