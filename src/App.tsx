...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f2f4f6] text-gray-900 font-sans pb-24">
      <header className="px-6 pt-12 pb-8 bg-white shadow-sm rounded-b-3xl mb-6 sticky top-0 z-10">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">SafeScan</h1>
        <p className="text-blue-500 font-medium mt-2 text-lg">
